...
- 전체 프론트 색감을 화이트 바탕, 우드 보조색, 파스텔 그린 포인트 중심으로 조정했다.
- 자산 화면 상단의 미사용 연필 아이콘 버튼을 제거하고, 자산 추가 `+` 버튼만 남겼다.
...
- 테마 브라우저 확인 통과: CSS 변수 `--page #f7f5ef`, `--surface #fffef9`, `--accent #9bcf8e`, `--wood #b8875d`
- 자산 화면 상단 액션 버튼 확인 통과: `+` 버튼 1개만 노출
